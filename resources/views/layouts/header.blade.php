  ...
  <div class="container">
    <div class="row display-flex">
      <div class="col-md-2 margin-auto trigger-menu">
        ...
        <div class="logo">
          <a class="logo-wrapper" href="{{ route('home_page') }}" title="{{ config('app.name') }}"><img src="{{ asset('images/chopper-311697_960_720.webp') }}" alt="{{ config('app.name') }}"></a>
        </div>
      </div>
...
<div class="mobile-main-menu">
  ...
  <div class="mobile-main-menu-bottom">
    <div class="mobile-support">
      ...
      <div class="info-support">
        <i class="fa fa-envelope" aria-hidden="true"></i> EMAIL: <a href="mailto:buonbanxemay@gmail.com" title="buonbanxemay@gmail.com">buonbanxemay@gmail.com</a>
      </div>
    </div>
  </div>
</div>
